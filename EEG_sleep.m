...
%         xlim([0 f_vect_low(j) + 5])
        var{i, j} = trapz(freq1, PSDx)/trapz(freq1_ep, PSDx_ep);
...
figure
t = (1:lep:lep*floor(length(EEG)/ep_samples))/3600;
subplot(421), plot(t,10*log10(var.beta)), title("Beta"),ylim([-10 50]), xlim([0 1]);
subplot(423), plot(t,10*log10(var.alpha)), title("Alpha"),ylim([-10 50]), xlim([0 1]);
subplot(425), plot(t,10*log10(var.theta)), title("Theta"),ylim([-10 50]), xlim([0 1]);
subplot(427), plot(t,10*log10(var.delta)), title("Delta"),ylim([-10 50]), xlim([0 1]);

subplot(422), plot(t,10*log10(var_per.beta)), title("Beta"),ylim([-10 50]), xlim([0 1]);
subplot(424), plot(t,10*log10(var_per.alpha)), title("Alpha"),ylim([-10 50]), xlim([0 1]);
subplot(426), plot(t,10*log10(var_per.theta)), title("Theta"),ylim([-10 50]), xlim([0 1]);
subplot(428), plot(t,10*log10(var_per.delta)), title("Delta"),ylim([-10 50]), xlim([0 1]);